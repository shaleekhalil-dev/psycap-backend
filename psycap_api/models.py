...
class EmployeePsyCap(models.Model):
    ...
    # أبعاد رأس المال النفسي مع قيود (0-5) - تم تصحيح اسم الـ Validator هنا
    hope = models.FloatField(default=0.0, validators=[MinValueValidator(0), MaxValueValidator(5)])
    efficacy = models.FloatField(default=0.0, validators=[MinValueValidator(0), MaxValueValidator(5)])
    resilience = models.FloatField(default=0.0, validators=[MinValueValidator(0), MaxValueValidator(5)])
    optimism = models.FloatField(default=0.0, validators=[MinValueValidator(0), MaxValueValidator(5)])
    
    # حقول التفاعل الجديدة للحفظ الدائم في PostgreSQL
    ...
    def average_score(self):
        # حساب المتوسط والتقريب لخانة عشرية واحدة
    ...
    class Meta:
        ...
        ordering = ['-created_at'] # عرض الأحدث أولاً في لوحة التحكم